...
class nbDetectorConstruction : public G4VUserDetectorConstruction
{
    ...
    public:
      ...
      void setLayer1Material(G4String matName);
      void setLayer2Material(G4String matName);
      void setLayer3Material(G4String matName);
      void setLayer4Material(G4String matName);
      void setLayer5Material(G4String matName);
      
      void setLayer1Height(G4double height); 
      void setLayer2Height(G4double height); 
      void setLayer3Height(G4double height); 
      void setLayer4Height(G4double height); 
      void setLayer5Height(G4double height); 
};
